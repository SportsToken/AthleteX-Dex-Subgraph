...
export function handleSync(event: Sync): void {
  ...
  pancake.totalLiquidityMATIC = pancake.totalLiquidityMATIC.minus(pair.trackedReserveMATIC as BigDecimal);
  ...
  pancake.totalLiquidityMATIC = pancake.totalLiquidityMATIC.plus(trackedLiquidityMATIC);
  pancake.totalLiquidityUSD = pancake.totalLiquidityMATIC.times(bundle.maticPrice);
...
export function handleSwap(event: Swap): void {
  ...
  pancake.totalVolumeMATIC = pancake.totalVolumeMATIC.plus(trackedAmountMATIC);
  ...
  pancakeDayData.dailyVolumeMATIC = pancakeDayData.dailyVolumeMATIC.plus(trackedAmountMATIC);
