...
export class AthleteXFactory extends ethereum.SmartContract {
  static bind(address: Address): AthleteXFactory {
    return new AthleteXFactory("AthleteXFactory", address);
  }
